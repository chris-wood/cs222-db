...
void print_point() {
    cout << "grad-point2: " << g_nGradPoint << "\t grad-extra-point2: " << g_nGradExtraPoint << endl;
    cout << "undergrad-point2: " << g_nUndergradPoint << "\t undergrad-extra-point2: " << g_nUndergradExtraPoint << endl;
}
