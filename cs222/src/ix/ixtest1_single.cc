...
void print_point() {
    cout << "grad-point1: " << g_nGradPoint << "\t grad-extra-point1: " << g_nGradExtraPoint << endl;
    cout << "undergrad-point1: " << g_nUndergradPoint << "\t undergrad-extra-point1: " << g_nUndergradExtraPoint << endl;
}
