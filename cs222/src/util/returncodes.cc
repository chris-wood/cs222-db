...
namespace rc
{
    const char* rcToString(int rc)
    {
		...
		case TABLE_SYSTEM_IN_BAD_STATE:				return "TABLE_SYSTEM_IN_BAD_STATE";
		...
		case ATTRIBUTE_STRING_NO_DOT_SEPARATOR:		return "ATTRIBUTE_STRING_NO_DOT_SEPARATOR";
		case ATTRIBUTE_STRING_NO_REL_DATA:			return "ATTRIBUTE_STRING_NO_REL_DATA";
		case ATTRIBUTE_STRING_NO_ATTR_DATA:			return "ATTRIBUTE_STRING_NO_ATTR_DATA";
        case BTREE_NO_MATCHING_INDEX:               return "BTREE_NO_MATCHING_INDEX";
		...
		case BTREE_ITERATOR_ILLEGAL_NON_LEAF_RECORD:return "BTREE_ITERATOR_ILLEGAL_NON_LEAF_RECORD";
		case TUPLE_COMPARE_CONDITION_FAILED:		return "TUPLE_COMPARE_CONDITION_FAILED";
		case INDEX_NOT_FOUND:						return "INDEX_NOT_FOUND";
		case ITERATOR_NEVER_CALLED:					return "ITERATOR_NEVER_CALLED";
